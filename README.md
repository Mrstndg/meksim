...
Dişli, vida, diferansiyel vida, kramayer, somun, piston ve hazne gibi parçaları gerçek
...
- **Simülasyon** — bir parçaya motor bağla, mekanizma bağlantı grafiği üzerinden hareketi yayar; çevrim oranları, hızlar ve (pompa için) dozaj analizi canlı hesaplanır.
...
- **Yardımcılar** — çarpışma kontrolü, çoğalt, dizi, mesafe ölç, patlatılmış görünüm, hazır şablonlar, JSON kaydet/aç, video ve görüntü alma.
